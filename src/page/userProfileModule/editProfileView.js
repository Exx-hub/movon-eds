...
function UserEditProfileModule(props) {
  ...
  const updateProfile = () => {
    ...
    if (!hasError && size > 0) {
      User.updatePersonalInfo(changeValues).then((e) => {
      ...
      <div className="main-creds" style={{ margin: 0 }}>
        <div className="item-wrapper">
          ...
          <Input
            style={{
              width: "100%",
              borderColor: `${
                errorState.firstName.enabled ? "red" : "#d9d9d9"
              }`,
            }}
            size="large"
          ...
          <span
            style={{
              color: "red",
              display: `${errorState.firstName.enabled ? "block" : "none"}`,
            }}
          >
            {" "}
            Error: {errorState.firstName.message}
          </span>
        </div>
        ...
        <div className="item-wrapper">
          ...
          <Input
            style={{
              width: "100%",
              borderColor: `${errorState.lastName.enabled ? "red" : "#d9d9d9"}`,
            }}
            size="large"
          ...
          <span
            style={{
              color: "red",
              display: `${errorState.lastName.enabled ? "block" : "none"}`,
            }}
          >
            {" "}
            Error: {errorState.lastName.message}
          </span>
        </div>
        ...
        <div className="item-wrapper">
          ...
          <Input
            ...
            style={{
              width: "100%",
              borderColor: `${
                errorState.phoneNumber.enabled ? "red" : "#d9d9d9"
              }`,
            }}
            size="large"
            type="number"
          ...
          <span
            style={{
              color: "red",
              display: `${errorState.phoneNumber.enabled ? "block" : "none"}`,
            }}
          >
            {" "}
            Error: {errorState.phoneNumber.message}
          </span>
        </div>
        ...
        <div className="item-wrapper">
          ...
          <Input
            style={{
              width: "100%",
              borderColor: `${
                errorState.displayId.enabled ? "red" : "#d9d9d9"
              }`,
            }}
            size="large"
          ...
          <span
            style={{
              color: "red",
              display: `${errorState.displayId.enabled ? "block" : "none"}`,
            }}
          >
            {" "}
            Error: {errorState.displayId.message}
          </span>
        </div>

        <div
          className="button-wrapper-edit"
          style={{
            alignSelf: "center",
            display: "flex",
            width: "100%",
