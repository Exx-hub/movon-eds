...
import { getCashierTextColor, getHeaderColor, getHeaderLogo, UserProfile } from "../../utility"
import { UserOutlined, PoweroffOutlined, InfoCircleOutlined } from "@ant-design/icons";
            ...
            <div className={"header-nav"} style={{color:'black'}}>
              <Dropdown overlay={menu} trigger={["click"]}>
                <Button
                  ...
                  <span style={{color:getCashierTextColor()}}>Hi {UserProfile.getUser().personalInfo.firstName}!</span>
