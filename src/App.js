...
import { ViewUserProfileModule , EditUserProfileModule } from './page/userProfileModule';
...
function App() {
  ...
  return (
    ...
    <Router>
      <Switch>
      <Route exact path={alterPath("/user-profile/edit")} render={props=> <EditUserProfileModule {...props} /> } /> 
      <Route exact path={alterPath("/user-profile")} render={props=> <ViewUserProfileModule {...props} />} /> 
